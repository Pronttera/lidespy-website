...
export const INDUSTRY_SOLUTIONS: SolutionCard[] = [
  { kicker: "Technology", headline: "Demand generation for technology companies",
  ...
  { kicker: "SaaS", headline: "Pipeline generation for SaaS companies",
  ...
  { kicker: "Cybersecurity", headline: "Demand generation for cybersecurity vendors",
  ...
  { kicker: "FinTech", headline: "B2B demand generation for FinTech companies",
  ...
  { kicker: "Healthcare", headline: "Demand generation for healthcare technology companies",
...
export const OBJECTIVE_SOLUTIONS: SolutionCard[] = [
  { kicker: "Generate more leads", headline: "Need more qualified leads? We build pipeline.",
  ...
  { kicker: "Build pipeline", headline: "From awareness to pipeline — end to end.",
  ...
  { kicker: "Accelerate sales", headline: "Book more meetings. Close more revenue.",
  ...
  { kicker: "Launch new markets", headline: "Enter new markets with confidence.",
  ...
  { kicker: "Improve ABM performance", headline: "Stop running ABM on assumptions.",
  ...
  { kicker: "Increase webinar attendance", headline: "Fill every seat. Engage the right buyers.",
